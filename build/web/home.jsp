...
<body>
    ...
    <script>
      ...
      const KB = [
        ...
        {k:['catálogo','catalogo','donde veo el catálogo','ver catálogo'], r:'Haz clic en la pestaña “Productos” o ingresa a /productos.jsp.'},
        {k:['pedido','comprar','compra','orden','cómo hago un pedido','como hacer un pedido'], r:'Inicia sesión, agrega productos al carrito y confirma la compra en la sección “Pedidos”.'},
        {k:['pago','pagos','metodos de pago','metodo de pago'], r:'Aceptamos pagos simulados en línea (demo) y pagos contra entrega.'},
        {k:['login','iniciar sesión','iniciar sesion','entrar','como inicio sesion'], r:'Inicia sesión desde la página login.jsp con tu correo y contraseña.'},
        {k:['registro','registrar','crear cuenta','como me registro'], r:'Por ahora el registro se hace en la base de datos con usuarios de prueba. Pronto estará disponible un formulario en línea.'},
        {k:['objetivo','proyecto','meta','para que sirve'], r:'OtakuShopWeb2 es un proyecto académico para gestionar una tienda online con Java, JSP, Servlets y MySQL.'},
        {k:['api','endpoint','rest','endpoints'], r:'Sí, tenemos endpoints REST para usuarios, productos, carrito y pedidos. Ejemplo: /api/productos'},
